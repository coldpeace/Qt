...
**
** Created: Fri Aug 20 17:20:00 2010
...
static const char qt_meta_stringdata_Wizard[] = {
    "Wizard\0\0directory\0projectSaved(QString)\0"
    "bypassXML()\0createProject()\0setDirectory()\0"
    "editText(QString)\0"
};
...
int Wizard::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: projectSaved((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: bypassXML(); break;
        case 2: createProject(); break;
        case 3: setDirectory(); break;
        case 4: editText((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 5;
    }
...
// SIGNAL 0
void Wizard::projectSaved(const QString & _t1)
{
